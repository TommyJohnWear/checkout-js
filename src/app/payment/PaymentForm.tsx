...
import { DocumentOnlyCustomFormFieldsetValues,
    FawryCustomFormFieldsetValues,
    IdealCustomFormFieldsetValues,
    SepaCustomFormFieldsetValues } from './checkoutcomFieldsets';
...
const HowHeard: FunctionComponent = () => {
    ...
    return (
        <div className="how-heard-wrapper">
            ...
            <p className="how-heard-subtitle">
                We&apos;ll owe you one! (of no dollar value)
            </p>
            <select
                className="how-heard-select"
                ...
                { shouldHidePaymentSubmitButton ? (
                    ...
                    <PaymentSubmitButton
                        initialisationStrategyType={
                            selectedMethod &&
                            selectedMethod.initializationStrategy?.type
                        }
                        ...
                        methodName={
                            selectedMethod &&
                            getPaymentMethodName(language)(selectedMethod)
                        }
        ...
        const handlePaymentMethodSelect = useCallback(
            (method: PaymentMethod) => {
                resetForm({
                    ...
                    ccNumber: '',
                    instrumentId: '',
                    paymentProviderRadio: getUniquePaymentMethodId(
                        method.id,
                        method.gateway
                    ),
...
const paymentFormConfig: WithFormikConfig<
